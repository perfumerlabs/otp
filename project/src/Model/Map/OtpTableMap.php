...
class OtpTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Channel', 'Target', 'Password', 'ExpireAt', 'CreatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'channel', 'target', 'password', 'expireAt', 'createdAt', ),
        self::TYPE_COLNAME       => array(OtpTableMap::COL_ID, OtpTableMap::COL_CHANNEL, OtpTableMap::COL_TARGET, OtpTableMap::COL_PASSWORD, OtpTableMap::COL_EXPIRE_AT, OtpTableMap::COL_CREATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'channel', 'target', 'password', 'expire_at', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Channel' => 1, 'Target' => 2, 'Password' => 3, 'ExpireAt' => 4, 'CreatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'channel' => 1, 'target' => 2, 'password' => 3, 'expireAt' => 4, 'createdAt' => 5, ),
        self::TYPE_COLNAME       => array(OtpTableMap::COL_ID => 0, OtpTableMap::COL_CHANNEL => 1, OtpTableMap::COL_TARGET => 2, OtpTableMap::COL_PASSWORD => 3, OtpTableMap::COL_EXPIRE_AT => 4, OtpTableMap::COL_CREATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'channel' => 1, 'target' => 2, 'password' => 3, 'expire_at' => 4, 'created_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
